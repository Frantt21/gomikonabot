...
//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊¿Que peyo?*\n┊💖 @user\n┊*Leete la Descripcion.*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ *@user*\n┊ *No aguanto la presion el imbecil* 👻\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
const smsContacto4 = () => { return 'Contacto Oficial de Fran 🐈'}
...
const smsImageGg = () => { return '👻 *Imagen:*'}
...
//menu-menu.js
const smsMenuTotal1 = () => { return "COMANDOS DEL MENÚ"}
